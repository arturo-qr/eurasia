	...
	<div id="PageContainer">
		...
		<div id="HomeColumn2">
			<div id="HomeGallery">
				...
				<br /><br />
				Our TViMama.com a TV-On-Demand Network will be streaming television programming and movie content to our subscribers’ computers and TV sets around the world. With almost seven billion people today, this business model has unlimited financial potential. 
				<br /><br />
				Our business model has several advantages that significantly distinguish it from traditional TV-On-Demand/Video on Demand(VOD) platforms, in that, our platform gives subscribers the opportunity to see almost 1 million Public Domain television programs and films in ethnic languages. 
				<br /><br />
				In addition to providing Public Domain content to our ethnic subscribers, Global’s TViMama.com business model replicates that of our European TV-On-Demand provider, which provides TViMama.com with software, hardware, computer programming support and other technological advancements. 
				<br /><br />
				<b>
				...
				<br /><br />
				Our strategic provider’s content library consists of TV Programs and feature films, most created by Eastern Europe television companies for the past 20 years. However, subscribers can also see all of today’s television programs from most of the Eastern Europe TV channels, as soon as broadcasting of the programs are completed on the TV channels. 
				<br /><br />
				...
				<br /><br /><br />
				<b>News category with 70,013 programs.</b> 
				<br /><br />
				<b>Music category with 12,863 programs.</b> 
				<br /><br /><br />
				<b>TV Shows category with 31,053 programs, and subcategories such as:</b>     
				<span lang="en" title="">
					<br />
					<br />
					• &nbsp;&nbsp;&nbsp; Music TV Shows (526)<br />
					• &nbsp;&nbsp;&nbsp; Reality show (333)<br />
					• &nbsp;&nbsp;&nbsp; Humorous TV shows (665)<br />
					• &nbsp;&nbsp;&nbsp; Cooking TV show (3221)<br />
					• &nbsp;&nbsp;&nbsp; Sports television show (130)<br />
					• &nbsp;&nbsp;&nbsp; Talk shows 8855<br />
					<br />
					<br />
				</span>
				<b>TV Programs category with 137,886 programs, and subcategories such as:</b>   
				<br />
				<span lang="en" title="">
					<br />
					• Education (1987)<br />
					...
					• Health (4607)<br />
					• Religion (1400)<br />
					• Entertainment (1861)<br />
					• Esoteric, Occultism, Mysticism (993)<br />
					• Political (6437)<br />
					• Culture, Arts (12 212)<br />
					• Documentary (5320)<br />
					• Military (323)<br />
					• TV game (6423)<br />
					• Animals, Nature, Travel (4479)<br />
					• Science and Technology (2108)<br />
					• Cooking (101)<br />
					• Social (2770)<br />
					• Criminal (8599)<br />
					• Information (60 391)<br />
					• Education (3967)<br />
					• Interior design, Fashion (2112)<br />
				</span>
				<br /><br />
				<b>Dramas category with 1,339 programs, and subcategories such as:</b>
				<br /><br />
				<span lang="en" title="">
					• &nbsp;&nbsp;&nbsp;Tragicomedy (37)<br />
					• &nbsp;&nbsp;&nbsp; Ballet (94)<br />
					• &nbsp;&nbsp;&nbsp; Drama (677)<br />
					• &nbsp;&nbsp;&nbsp; Operetta, musical (41)<br />
					• &nbsp;&nbsp;&nbsp; Comedy (259)<br />
					• &nbsp;&nbsp;&nbsp; Solo performances (38)<br />
					• &nbsp;&nbsp;&nbsp; Opera (79)<br />
					• &nbsp;&nbsp;&nbsp; Children&#39;s shows (28)<br />
				</span>
				<br /><br />
				<b>Cartoons for Adults category with 508 programs.</b>  
				<br /><br /><br />
				<b>TV Soaps and Series category with 55, 207 programs, and subcategories such as: </b>
				<br /> <br />
				<span lang="en" title="">• &nbsp;&nbsp;&nbsp; Action (2320)<br />
					• &nbsp;&nbsp;&nbsp; Horror (209)<br />
					• &nbsp;&nbsp;&nbsp; Biography (379)<br />
					• &nbsp;&nbsp;&nbsp; TV Story (355)<br />
					• &nbsp;&nbsp;&nbsp; Music (499)<br />
				...
				<br /><br /><br />
				<b>Music Recordings category with 249 programs.</b> 
				<br /><br /><br />
				<b>Sports category with 48, 990 programs, and subcategories such as:</b>
				<br /><br />
				<span lang="en" title="">
					• &nbsp;&nbsp;&nbsp; Soccer (19 072)<br />
					• &nbsp;&nbsp;&nbsp; Billiards (203)<br />
					...
					• &nbsp;&nbsp;&nbsp; Athletics (350)<br />
					• &nbsp;&nbsp;&nbsp; Pentathlon (31)<br />
					• &nbsp;&nbsp;&nbsp; Winter Sports (626)<br />
					• &nbsp;&nbsp;&nbsp; Badminton (60)<br />
					• &nbsp;&nbsp;&nbsp; Tennis (654)<br />
					• &nbsp;&nbsp;&nbsp; Fighting (477)<br />
					• &nbsp;&nbsp;&nbsp; Volleyball (599)<br />
					• &nbsp;&nbsp;&nbsp; Gymnastics (124)<br />
					• &nbsp;&nbsp;&nbsp; Figure skating (165)<br />
					• &nbsp;&nbsp;&nbsp; Chess (268)<br />
					• &nbsp;&nbsp;&nbsp; Equestrian (1)<br />
					• &nbsp;&nbsp;&nbsp; Auto Racing (3141)<br />
					• &nbsp;&nbsp;&nbsp; Martial Arts (918)<br />
				...
				<br />
				<b>Feature Films category with 12,554 movies, and subcategories such as:</b>
				<br /><br />
				<span lang="en" title="">
					• &nbsp;&nbsp;&nbsp; Action (782)<br />
					• &nbsp;&nbsp;&nbsp; Horror (226)<br />
				...
				<br /><br /><br />
				<b>Documentary Films category with 20,944 films, and subcategories such as:  </b>
				<br /><br />
				<span lang="en" title="">
					• &nbsp;&nbsp;&nbsp; Historical (5238)<br />
					• &nbsp;&nbsp;&nbsp; Animals, Nature, Travel (92)<br />
					• &nbsp;&nbsp;&nbsp; Psychological (1067)<br />
					• &nbsp;&nbsp;&nbsp; Military (1408)<br />
					• &nbsp;&nbsp;&nbsp; Scientific and educational (31)<br />
					• &nbsp;&nbsp;&nbsp; Biography (5871)<br />
					• &nbsp;&nbsp;&nbsp; Cultural and educational (385)<br />
					• &nbsp;&nbsp;&nbsp; Other (6357)<br />
					• &nbsp;&nbsp;&nbsp; Criminal (548)
				</span>
				<br /><br /><br />
				<b>Cartoons, Movies, and Children&#39;s Programs category with 10,789 programs, and subcategories such as</b>:
				<br /><br />
				<span lang="en" title="">
					• &nbsp;&nbsp;&nbsp; Children&#39;s Programs (4875)<br />
					• &nbsp;&nbsp;&nbsp; Children&#39;s series (145)<br />
					• &nbsp;&nbsp;&nbsp; Animation (2453)<br />
					• &nbsp;&nbsp;&nbsp; Cartoons (2920)<br />
				...
				<br /><br />
				With this unique and popular business model we hope to avoid competition in United States and other markets with the Video on demand network’s of the world, which are competing for popular movies with everyone else. 
				<br /><br />
				...
				<span class="style1">
					Click on the link selection below
				</span>
				<BR /><BR />
				<a href="mailto:Globalhost@yahoo.com">I Would like to invest in Global Entertainment & Media, Ltd. </a>
				<BR /><BR />
				<a href="mailto:Globalhost@yahoo.com">I would like to apply for a job at Global Entertainment & Media, Ltd.</a>
				<BR /><BR />
				<a href="mailto:Globalhost@yahoo.com">I would Like to make a charitable donation to Global' Classical Art, Music and Architecture Foundation. </a>
				<BR /><BR />
				<a href="mailto:Globalhost@yahoo.com">I would like to sell products or services to Global Entertainment & Media, Ltd.</a>
				<BR /><BR />
				<a href="mailto:Globalhost@yahoo.com">I would like to receive more information on Global Entertainment & Media, Ltd.</a>
				<BR /><BR />
				<a href="mailto:Globalhost@yahoo.com">I would like to refer someone to Global Entertainment & Media, Ltd.</a>
				<BR /><BR />
				<a href="mailto:Globalhost@yahoo.com">I would like to give an advise or recommendation to Global Entertainment & Media, Ltd.</a>
				<BR /><BR />
				<a href="mailto:Globalhost@yahoo.com">I would like to present an opportunity to Global Entertainment & Media, Ltd.</a>
				<BR /><BR />
				<a href="mailto:Globalhost@yahoo.com">I have a question or questions for Global Entertainment & Media, Ltd.</a>
				<BR /><BR />
				<a href="mailto:Globalhost@yahoo.com">I need Global' help or assistance.</a>
				<BR /><BR />
				<a href="mailto:Globalhost@yahoo.com">I would like to share some information with Global Entertainment & Media, Ltd.</a>
				<BR /><BR />
				<span class="style1">
				...
				<a href="#" onclick=getNewPage('Risk-Factors.aspx');>RISK FACTORS.</a>
				<BR /><BR />
			</div>
