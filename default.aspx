		...
		<div id="HomeColumn1">
			<div id="flashvideo2">
				<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="450" height="350" >
					...
					<param name="flashvars" value="autoplay=true&amp;v=media/fPXTV_DOSIS_DIARIA_test.mp4&amp;img=Untitled-6.png&amp;repeat=true&amp;btnIcon=#6CFF00&amp;playIcon=#6CFF00&amp;controlsBgAlpha=0" />
					...
					<object type="application/x-shockwave-flash" data="videoplayer.swf" width="450" height="350">
						...
						<param name="loop" value="true" />
						<param name="allowFullScreen" value="true" />
						<param name="flashvars" value="autoplay=true&amp;v=media/PXTVf_DOSIS_DIARIA_test.mp4&amp;img=Untitled-6.png&amp;repeat=true&amp;btnIcon=#6CFF00&amp;playIcon=#6CFF00&amp;controlsBgAlpha=0" />
						<param name="wmode" value="transparent" />
						<param name="scale" value="tofit" />
						<param name="menu" value="true" />
						<param name="devicefont" value="false" />
					...
					<div id="DetailCopy">
						...
						<ul class="overview-list">
							...
							<ul class="overview-list-deep">
								...
								<li>Tickets to any Amusement Venue in EURASIA Hotel Casino Resort</li>
								<li>Helicopter tours.</li>
								<li>Gift Certificates and discounts for EURASIA shops, restaurants, spas, golf course,beauty salons, etc.</li>
								<li>Tickets for FORMULA 1, INDY and other races.</li>
								<li>Driving racing cars. Tours to pits. Photo-ops with racecar drivers.</li>
								<li>Marketing Benefits for <strong><u>NeuroMama</strong></u> EURASIA Resort and EURASIA Mall Tenants with Sports, Intellectual, Arts, Entertainment, Adult, Children, Teams and Other Competitions.</li>
							</ul>
						</ul>
						<span class="style4">
							<u>NeuroMama</u> IS THE PROACTIVE provider of FIRST CONTENT Delivery Platform designed from the ground up to deliver the QUANTUM IMPROVEMENTS in BANDWIDTH FLOW RATE, CAPACITY and COMPRESSION needed to satisfy Web 2.0 demand for an Internet backbone that will support seamless real-time collaboration between groups of people all over the world simultaneously working with the same on-line documents and software, securitized by ENTERTAINMENT ASSETS for the 21st Century.
						</span>
					</div>
				</div>
			</div>
